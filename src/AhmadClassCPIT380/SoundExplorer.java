...
/**
 * This class allows you to explore a Sound. You can see the line drawing of the
...
public class SoundExplorer implements MouseMotionListener, ActionListener,
     ...
     */
    public SoundExplorer(SimpleSound sound, boolean inStereo, String title) {
        this.sound = sound;
...
//    }
    ...
    /**
     * Method to create the panel that has the buttons for playing all or part
     * of the sound. Also shows information about the selection (if one)
     */
    ...
    /**
     * Method to set up the index panel. This panel has buttons for going to the
    ...
    /**
     * Method to create the information panel which holds the index information,
     * the value for the current index, and the zoom button
     */
    ...
    private void handleZoomIn(boolean checkScrollFlag) {
        ...
        if (inStereo) {
            rightSoundPanel.setPreferredSize(new Dimension(zoomInWidth,
                    rightSoundPanel.getHeight()));
            rightSoundPanel.setSize(rightSoundPanel.getPreferredSize());

            rightSampleWrapper.setPreferredSize(new Dimension(zoomInWidth,
                    rightSampleWrapper.getHeight()));
            rightSampleWrapper.setSize(rightSampleWrapper.getPreferredSize());

            rightSamplePanel.setPreferredSize(new Dimension(zoomInWidth,
    ...
    private void handleZoomOut() {
        ...
        soundPanel.setPreferredSize(new Dimension(zoomOutWidth,
                soundPanel.getHeight()));
        soundPanel.setSize(soundPanel.getPreferredSize());

        leftSoundPanel.setPreferredSize(new Dimension(zoomOutWidth,
                leftSoundPanel.getHeight()));
        leftSoundPanel.setSize(leftSoundPanel.getPreferredSize());

        leftSampleWrapper.setPreferredSize(new Dimension(zoomOutWidth,
                leftSampleWrapper.getHeight()));
        leftSampleWrapper.setSize(leftSampleWrapper.getPreferredSize());
        ...
        if (inStereo) {
            rightSoundPanel.
                    setPreferredSize(new Dimension(zoomOutWidth,
                            rightSoundPanel.getHeight()));
            rightSoundPanel.setSize(rightSoundPanel.getPreferredSize());

            rightSampleWrapper.setPreferredSize(new Dimension(zoomOutWidth,
                    rightSampleWrapper.getHeight()));
            rightSampleWrapper.setSize(rightSampleWrapper.getPreferredSize());
    ...
    private void handleFramesPerPixel(int numFrames) {
        ...
        soundPanel.setPreferredSize(new Dimension(sampleWidth,
                soundPanel.getHeight()));
        soundPanel.setSize(soundPanel.getPreferredSize());

        leftSoundPanel.setPreferredSize(new Dimension(sampleWidth,
                leftSoundPanel.getHeight()));
        leftSoundPanel.setSize(leftSoundPanel.getPreferredSize());

        leftSampleWrapper.setPreferredSize(new Dimension(sampleWidth,
                leftSampleWrapper.getHeight()));
        leftSampleWrapper.setSize(leftSampleWrapper.getPreferredSize());
        ...
        if (inStereo) {
            rightSoundPanel.
                    setPreferredSize(new Dimension(sampleWidth,
                            rightSoundPanel.getHeight()));
            rightSoundPanel.setSize(rightSoundPanel.getPreferredSize());

            rightSampleWrapper.setPreferredSize(new Dimension(sampleWidth,
                    rightSampleWrapper.getHeight()));
            rightSampleWrapper.setSize(rightSampleWrapper.getPreferredSize());
     ...
     *
     * @param base the new base to use (for example use setBase(1)) to use base
     * 1 instead of 0
     */
    ...
    private class SamplingPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = (int) rectToPaint.getX();
                ...
                g2.draw(new Line2D.Float((Point2D.Float) points.elementAt(i),
